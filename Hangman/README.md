...
Misses: q w e r y u i
    ...
    O   |
        ...
        |
        |
Hint: **o*t, Input a character.
p
Misses: q w e r y u i p
    +---+
    O   |
   /|\  |
        |
...
Misses: q w e r y u i p
   ...
   /|\  |
        |
        |
Hint: **oat, Input a character.
s
Misses: q w e r y u i p s
    +---+
    O   |
   /|\  |
    |   |
...
* Hangman without malloc function
```C
/*
 *  Keywords in C Programming
 *  -----------------------------
