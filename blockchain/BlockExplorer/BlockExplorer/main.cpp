...
/*
    ...
    *      4. 사용자로부터 입력되는 메세지 처리(Message LoophInstance
    *
    *  )       : 프로그램의 인스턴스 핸들
...
extern WCHAR szheader2[MAX_LOADSTRING];
                     ...
                     _In_ int           nCmdShow)
{
    ...
    LoadStringW(hInstance, IDS_APP_header2, szheader2, MAX_LOADSTRING);         //  전역 문자열을 초기화합니다.
    LoadStringW(hInstance, IDC_BLOCKEXPLORER, szWindowClass, MAX_LOADSTRING);   //  전역 문자열을 초기화합니다.
    if (!MyRegisterClass(hInstance)) {
         ...
         *              MbitHeightSizeESNO            : 예 | 아니요
         *              MbitHeightSizeESNOCANCEL      : 예 | 아니오 | 취소
    ...
    /*  
     *  응용 프로그램 초기화를 수행합니다.
     *  InitInstance()->CreateWindow() 과정이 실패한 경우,
     */
